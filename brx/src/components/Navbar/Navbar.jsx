        ...
        <nav className='flex items-center justify-between'>
            ...
            <div className={`nav-list lg:block absolute right-10 lg:relative lg:top-0 transition-all duration-100 ease-in ${isOpen ? "top-[50px]":"top-[-100px]"}`}>
                <ul className={`flex text-maroon-300  ${isOpen? "flex-col space-y-5": "flex-row space-x-6"}`}>
                    ...
                    <li className='hover:text-[#21209C] transition-all duration-200 ease-in cursor-pointer text-[20px] bold'><a href="#projects">Projects</a></li>
                    <li className='hover:text-[#21209C] transition-all duration-200 ease-in cursor-pointer text-[20px] bold'><a href="#technologies">Achievements</a></li>
