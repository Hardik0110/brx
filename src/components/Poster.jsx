    ...
    <motion.div 
        ...
        <div className='grid sm:grid-cols-2 p-8'> 
            <div className='w-10/12 mx-auto flex flex-col justify-center xl:text-4xl text-3xl'>
                <span>We Are Finding</span>
                <span>Clients To Work With</span>
            </div>
            <div className="flex flex-col justify-center">
                <p className='xl:text-[13px] text-[10px] w-10/12 mb-5'>more despcription and more description</p>
                <div className='w-32 h-10 flex items-center justify-center bg-white rounded-full'>
                    <a href="#contact" className='text-[#301934] flex items-center justify-between xl:text-base text-[13px]'>Contact Us <AiOutlineArrowRight/></a>
                </div>
            </div>
        </div>
    </motion.div>
